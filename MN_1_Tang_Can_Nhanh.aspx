<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MN_1_Tang_Can_Nhanh.aspx.cs" Inherits="Tang_Can_Nhanh" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="main">
        <div id="top" style="margin-left:100px">
        </div>
        ...
        <div id="content">
            ...
            <img src="./tang_Can_Nhanh/L_Tang_Can_Nhanh.jpg" style="width:881px; height:300px"/><br /><br />

            <h4>Tăng cân nhanh </h4>
