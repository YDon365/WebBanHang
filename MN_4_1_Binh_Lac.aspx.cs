...
public partial class Binh_Lac : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select id,sp.MaSP, hinhSP,tenSP,donGia from  HINHSP h,SANPHAM sp where sp.MaSP=h.MaSP and MaLoai='LH08'", cn1);
