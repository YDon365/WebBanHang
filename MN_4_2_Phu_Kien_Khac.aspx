<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MN_4_2_Phu_Kien_Khac.aspx.cs" Inherits="Phu_Kien_Khac" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="main">
        ...
        <div id="content">
            ...
            <img src="./Phu_Kien/L_Khac.jpg" style="width:881px; height:300px"/><br /><br />
            ...
            <asp:DataList ID="DataList1" runat="server" RepeatColumns="2" >
                <ItemTemplate>
                    <a href='SP_Phu_Kien.aspx?ID=<%#Eval("MaSP")%>' style="list-style-type:none;text-decoration: none;">
                        <table class="auto-style27">
                        <tr>
                            <td><asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("hinhSP") %>' width="330px" height="300px" /></td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                        <tr>
                            <td><asp:Label ID="Label1" runat="server" Text='<%# Eval("tenSP") %>'></asp:Label></td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><asp:Label ID="Label2" runat="server" Text='<%# Eval("donGia") %>' CssClass="auto-style28"></asp:Label>&nbsp; <b style="color:red">VND</b> 
                                <br />
            ...
            <b style="color:#808080">________________________________________________________________________________________</b><br /><br />
                ...
                <div>
                    <h4 style="color:#00ff21">Nguồn gốc của các loại Mass tăng cân nhanh tốt hiện nay</h4><br /><br />
